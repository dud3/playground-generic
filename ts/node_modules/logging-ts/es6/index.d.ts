 ...
 * @since 0.3.0
 */
import { Applicative, Applicative1, Applicative2 } from 'fp-ts/es6/Applicative'
 ...
 * @since 0.3.0
 */
export declare function getLoggerM<M extends URIS2>(M: Applicative2<M>): LoggerM2<M>
export declare function getLoggerM<M extends URIS>(M: Applicative1<M>): LoggerM1<M>
export declare function getLoggerM<M>(M: Applicative<M>): LoggerM<M>
