...
// constructors
// -------------------------------------------------------------------------------------
var getMonoidSetting = function (empty) { return (__assign(__assign({}, S.getLastSemigroup()), { empty: empty })); };
var monoidConfig = M.getStructMonoid({
 ...
 * @since 0.6.4
 */
var build = function (projectName, projectHomepage) { return function (config) { return (__assign(__assign({}, config), { projectName: projectName, projectHomepage: config.projectHomepage.length === 0 ? projectHomepage : config.projectHomepage })); }; };
exports.build = build;
// -------------------------------------------------------------------------------------
// destructors
// -------------------------------------------------------------------------------------
 ...
 * @since 0.6.4
 */
var updateProjectHomepage = function (projectHomepage) { return function (wa) {
 ...
 * @since 0.6.0
 */
var updateSourceDir = function (srcDir) { return function (wa) {
    return C.extend(wa, function (builder) {
 ...
 * @since 0.6.0
 */
var updateOutDir = function (outDir) { return function (wa) {
    return C.extend(wa, function (builder) {
 ...
 * @since 0.6.0
 */
var updateTheme = function (theme) { return function (wa) {
    return C.extend(wa, function (builder) {
 ...
 * @since 0.6.0
 */
var updateSearchEnabled = function (enableSearch) { return function (wa) {
    return C.extend(wa, function (builder) {
 ...
 * @since 0.6.0
 */
var updateEnforceDescriptions = function (enforceDescriptions) { return function (wa) {
    return C.extend(wa, function (builder) {
 ...
 * @since 0.6.0
 */
var updateEnforceExamples = function (enforceExamples) { return function (wa) {
    return C.extend(wa, function (builder) {
 ...
 * @since 0.6.0
 */
var updateEnforceVersion = function (enforceVersion) { return function (wa) {
    return C.extend(wa, function (builder) {
 ...
 * @since 0.6.0
 */
var updateExclusions = function (exclude) { return function (wa) {
    return C.extend(wa, function (builder) {
...
var validation = TE.getTaskValidation(semigroupError);
var decodeValidKeys = function (record) {
    return function_1.pipe(record, RR.traverseWithIndex(validation)(function (key, value) {
        return RA.elem(Eq.eqString)(key)(validConfigurationkeys)
            ? TE.right(value)
...
var decode = function (input) {
    var configDecoder = function_1.pipe(TD.UnknownRecord, TD.parse(decodeValidKeys), TD.compose(TD.partial({
    ...
    return function_1.pipe(configDecoder.decode(input), TE.mapLeft(TD.draw));
};
