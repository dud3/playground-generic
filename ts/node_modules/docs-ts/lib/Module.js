 ...
 * @since 0.6.0
 */
var Module = function (documentable, path, classes, interfaces, functions, typeAliases, constants, exports) { return (__assign(__assign({}, documentable), { path: path,
    classes: classes,
 ...
 * @since 0.6.0
 */
var Class = function (documentable, signature, methods, staticMethods, properties) { return (__assign(__assign({ _tag: 'Class' }, documentable), { signature: signature,
    methods: methods,
 ...
 * @since 0.6.0
 */
exports.ordModule = function_1.pipe(Ord.ordString, Ord.contramap(function (module) { return module.path.join('/').toLowerCase(); }));
