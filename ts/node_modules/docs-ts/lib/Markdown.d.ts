 ...
 * @since 0.6.0
 */
export declare type Printable = Class | Constant | Export | Function | Interface | TypeAlias;
/**
 * @category model
 * @since 0.6.0
 */
export declare type Markdown = Bold | Fence | Header | Newline | Paragraph | PlainText | PlainTexts | Strikethrough;
/**
 * @category model
 * @since 0.6.0
 */
